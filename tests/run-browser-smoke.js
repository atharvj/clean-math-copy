...
function isolatedExtension(profile, scriptSource, relaySource) {
  ...
  const prelude = [
    ...
    '  const parent = hasParent ? parentOrTag : (document.head || document.documentElement);',
    '  const tagName = hasParent ? tagOrAttributes : parentOrTag;',
    '  const attributes = hasParent ? attributesInput : tagOrAttributes;',
